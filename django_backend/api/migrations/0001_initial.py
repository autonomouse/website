# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-31 12:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='About', help_text='Name of section.', max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='statements', to='api.Section')),
            ],
            options={
                'abstract': False,
            },
